...
export const ruleRegistry: Record<string, IRuleSet> = {
  ...
  navbar: {
    ...
    architectureRules: ["export const Navbar"],
  ...
  modal: {
    ...
    mustNotContain: ["any", "style={{", "TODO", "Tailwind"],
    accessibilityRules: ["aria-modal", "role=\"dialog\"", "aria-labelledby"],
  ...
  accordion: {
    ...
    mustNotContain: ["any", "style={{", "TODO", "Tailwind"],
    accessibilityRules: ["aria-expanded", "aria-controls", "role=\"button\""],
  ...
  tabs: {
    ...
    architectureRules: ["export const Tabs"],
    stylingRules: [".module.css"],
    typescriptRules: ["interface", ": string", ": boolean", ": React.ReactNode"],
    qualityWeights: defaultWeights,
  },
  ...
  "profile-card": {
    ...
    architectureRules: ["export const ProfileCard"],
    stylingRules: [".module.css", "@media"],
    typescriptRules: ["interface", ": string"],
    qualityWeights: defaultWeights,
  },
